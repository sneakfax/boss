...
# LICENSE
   **Лицензия: MPL-2.0**<br>
   Если вы пользуетесь данной программой вы соглашаетесь с лицензией MPL-2.0. **Согласно MPL-2.0 разработчики не несут ответственности за действия которые делались с помощью данной программы** (т.е. если у вас будут проблемы с законом - эти проблемы остаются у вас). 
